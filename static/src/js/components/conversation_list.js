...
class ConversationsList extends Component {
    ...
    render(){
        ...
        let conversationsList = conversations.data.map((conversation) => {
            return (
                <li key={conversation._id} id={conversation._id} aria-layout="row" aria-layout-align="space-between start" className="collection-item avatar" onClick={this.openConversation.bind(this)} dir="rtl">
